...
export function HeroArtifact({ locale }: HeroArtifactProps) {
  ...
  return (
    <figure className="hero-artifact" aria-label={dictionary.artifact.aria}>
        ...
        <div className="artifact-portrait">
          {profile.photo ? (
            ...
            <svg viewBox="0 0 460 520" aria-hidden="true">
              ...
              <path
                d="M-24 418c72-121 157-174 256-158 79 13 143 79 192 198v62H-24Z"
                fill="#c55e39"
              />
              <path
                d="M146 382c13-105 51-165 114-180 74-18 122 39 144 170l-46 148H148Z"
                fill="#f2e8d7"
              />
              <circle cx="270" cy="176" r="78" fill="#161713" />
              <path
                d="M196 182c18-91 92-127 155-80 48 36 39 105 1 151-40 49-120 27-149-17-11-18-12-35-7-54Z"
                fill="#161713"
              />
              <path
                d="M232 212c9 44 62 63 97 33 15-12 25-30 29-51-12 9-31 13-56 11-30-3-54-15-70-35-5 14-5 28 0 42Z"
                fill="#d8c4a3"
              />
              <path
                d="M214 348c25-55 69-79 122-65 45 12 74 50 89 113l-5 124H197Z"
                fill="#244936"
              />
              <path
                d="M34 92h106M34 120h72M34 148h93"
                stroke="#79a99a"
                strokeWidth="4"
                strokeLinecap="round"
              />
